...
QUEST_SYSTEM_NPC_INFO = {
    { QuestIdentification = 1, Level = 220, Reset = 1, MReset = 0, Zen = 0, Coin1 = 0, Coin2 = 0, Coin3 = 0, Vip = 0, Kills = 0, QuestName = 'KG-Emulator - Quest 1', Validity = '05/12/2023' },
    { QuestIdentification = 2, Level = 400, Reset = 100, MReset = 1, Zen = 0, Coin1 = 0, Coin2 = 0, Coin3 = 0, Vip = 0, Kills = 0, QuestName = 'KG-Emulator - Quest 2', Validity = '06/12/2023' },
...
[1] = 'Sistema de quest',
[2] = 'Valida até o dia: %s',
[3] = 'Voce ainda nao iniciou nenhuma quest',
...
[2] = 'Valido hasta el dia: %s',
[3] = 'Aun no has comenzado ninguna mision',
[4] = 'Te gustaria comenzar la mision?',
[5] = 'Iniciar mision',
...
[19] = '- Obtener %dx %s',
[20] = 'Premios:',
[21] = 'La mision ha sido completada!',
[22] = 'Continuar',
[23] = 'Cerrar',
}
...
function QuestSystemNpc.RenderTextReward(questInfo)
    ...
    then
        for key in pairs(RewardItens) do
            ...
            if item.Class == -1 or item.Class == UserGetClass()
            then
...
function QuestSystemNpc.UpdateProc()
	...
	m_Pos.x = 450 + (ReturnWideScreenX() * 2)
...
function QuestSystemNpc.Open(PacketName)
    ...
    QuestSystemNpcInfo = { QuestIdentification = QuestIdentification, Level = Level, Resets = Resets, MResets = MResets, Zen = Zen, Coin1 = Coin1, Coin2 = Coin2
                        , Coin3 = Coin3, Vip = Vip, Kills = Kills }
